...
import profilePic from "../../images/george-marriott.jpg"
...
class About extends Component {
    ...
    render(){
        return (
            <section id="about">
            <div className='row'>
                    <h3 className="profile-title">George Marriott</h3>
                    <div className="banner-text">
                        <h1 className="responsive-headline"><img className="profile-img" src={profilePic} alt='profile-pic'></img></h1>

      ...
      <header id="home">
        ...
        <h3 className="title"><Zoom cascade duration={4000}>George Marriott</Zoom></h3>
          <div className="banner-text">
            ...
            <h3 className="intro-text"><Zoom cascade duration={4000}>I'm a Sheffield based Fullstack Web Developer currently specialising in React and PHP. I have a keen interest in UX design and backend web structure.</Zoom></h3>
            <hr />
            <ul className="social">
